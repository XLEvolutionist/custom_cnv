...
group1<-rownames(cnv.mat)[which(groups == unique(groups)[1])]
group2<-rownames(cnv.mat)[which(groups == unique(groups)[2])]
group3<-rownames(cnv.mat)[which(groups == unique(groups)[3])]
group4<-rownames(cnv.mat)[which(groups == unique(groups)[4])]
