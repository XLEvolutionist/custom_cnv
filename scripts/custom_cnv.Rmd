...
```{r}
par(mfrow=c(2,1))
vioplot(geneStats$TD[geneStats$Group.1 %in% group1 & subgenome == "m1" ],geneStats$TD[geneStats$Group.1 %in% group2 &  subgenome == "m1"],geneStats$TD[geneStats$Group.1 %in% group3 &  subgenome == "m1"],geneStats$TD[geneStats$Group.1 %in% group4 & subgenome == "m1"], col="blue", ylim=c(-2,2))
title(ylab="Tajima's D", xlab="group")
vioplot(geneStats$TD[geneStats$Group.1 %in% group1 & subgenome == "m2" ],geneStats$TD[geneStats$Group.1 %in% group2 &  subgenome == "m2"],geneStats$TD[geneStats$Group.1 %in% group3 &  subgenome == "m2"],geneStats$TD[geneStats$Group.1 %in% group4 & subgenome == "m2"], col="red", ylim=c(-2,2))
title(ylab="Tajima's D", xlab="group")
```